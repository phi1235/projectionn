...
Route::get('read', [CustomAuthController::class, 'readUser'])->name('crud_user.readUser');
Route::get('delete', [CustomAuthController::class, 'deleteUser'])->name('crud_user.deleteUser');
Route::get('update', [CustomAuthController::class, 'updateUser'])->name('crud_user.updateUser');
Route::post('update', [CustomAuthController::class, 'postUpdateUser'])->name('crud_user.postUpdateUser');
